...
<div class="card text-bg-dark rounded-0 position-relative mobile-show">
    <img src="assets/img/joinwithus-mobile.svg" class="card-img" alt="joinwithus">
    <div class="card-img-overlay mt-5">
      <h2 class="card-title mt-5 ms-1 pt-3 fw-bold">Create Good <br> Business With Us</h2>
      <p class="card-text ms-1 text-primary fw-500 fs-5">Grow Together To Achive Goals!</p>
      <div class="d-grid gap-2">
        <a href="/contact-us" type="button" class="btn btn-black opacity-75 text-white ms-1 rounded-0 position-absolute bottom-0">Join With Us !<i class="pl-5 text-end bi bi-caret-right ms-5"></i></a>
      </div>
    </div>
</div>