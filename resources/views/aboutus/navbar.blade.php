    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link fw-bold active" href="/about-us">About Us</a>
            </li>
            <li class="nav-item">
        ...
        <div class="me-auto">
          <a class="btn btn-info rounded-0" href="/contact-us">Contact Us!</a>
        </div>
    </div>
</nav>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active fw-bold" href="/about-us">About Us</a>
        </li>
        <li class="nav-item">
          <a class="nav-link fw-bold" href="/what-we-do">What We Do</a>
        </li>
